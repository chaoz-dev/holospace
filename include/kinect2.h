...
class Kinect2Device {
public:
	Kinect2Device(std::shared_ptr<libfreenect2::Freenect2> freenect2_ptr,
			size_t cam_num,
			int cam_type = Kinect2CamType::COLOR | Kinect2CamType::DEPTH,
	...
	void stop();
	void read_cloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr out_cloud_ptr,
			size_t timeout_sec = 10) const;
	void read_cloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr out_cloud_ptr,
			cv::Mat & out_rgb_mat, cv::Mat & out_depth_mat, size_t timeout_sec =
					10) const;
...
private:
	struct Kinect2FrameParam {
		...
		static constexpr size_t FRAME_AREA { FRAME_HEIGHT * FRAME_WIDTH };
	...
	public:
		...
		libfreenect2::Frame undistorted_frame { Kinect2FrameParam::FRAME_WIDTH,
				Kinect2FrameParam::FRAME_HEIGHT,
				Kinect2FrameParam::BYTES_PER_PIX };
		libfreenect2::Frame registered_frame { Kinect2FrameParam::FRAME_WIDTH,
				Kinect2FrameParam::FRAME_HEIGHT,
				Kinect2FrameParam::BYTES_PER_PIX };

		cv::Mat depth_mat { Kinect2FrameParam::FRAME_HEIGHT,
				Kinect2FrameParam::FRAME_WIDTH, CV_8UC4, undistorted_frame.data };
		cv::Mat rgb_mat { Kinect2FrameParam::FRAME_HEIGHT,
				Kinect2FrameParam::FRAME_WIDTH, CV_8UC4, registered_frame.data };

		Kinect2Frame(libfreenect2::SyncMultiFrameListener & listener) :
	...
	bool read_frame(Kinect2Frame & frame, size_t timeout_sec = 10) const;
	void read_cloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr out_cloud_ptr,
